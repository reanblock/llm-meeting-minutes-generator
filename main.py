...
NOTE: place any audio file (that has some speech!) in audio/sample.mp3 (it is git ignored anyway!).
"""
...
outputs = model.generate(input_ids=input_ids, max_new_tokens=2000, streamer=streamer)
